...
var asyncFunctwo = function(i) {
    return new Promise(function(resolve, reject) {
        setTimeout(function() {
            ...
            var codetype_id="6258d6445b891f24cc62876a"
            var platform_id="6258d41ae23e791bb5111752"
            var type_id="6258d72d3ce310288fa8c7c1"
            Shop.create({
                shop_name:shop_name,
                picture:"https://www.sonorous.icu/wp-content/uploads/2022/03/cropped-jarrod-terry-simpsons.jpg",
                price:50,
...
var asyncFuncthree = function(i) {
    return new Promise(function(resolve, reject) {
        setTimeout(function() {
            ...
            var codetype_id="6258d6445b891f24cc62876a"
            var platform_id="6258d418e23e791bb511174e"
            var type_id="6258d72e3ce310288fa8c7c3"
            Shop.create({
                shop_name:shop_name,
                picture:"https://www.sonorous.icu/wp-content/uploads/2022/03/cropped-jarrod-terry-simpsons.jpg",
                price:50,
...
var asyncFuncfour = function(i) {
    return new Promise(function(resolve, reject) {
        setTimeout(function() {
            ...
            var codetype_id="6258d6455b891f24cc62876e"
            var platform_id="6258d418e23e791bb511174e"
            var type_id="6258d72e3ce310288fa8c7c3"
            Shop.create({
                shop_name:shop_name,
